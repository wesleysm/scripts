...
3) pacman -Sy --noconfirm cinnamon gvfs gvfs-afc gvfs-goa gvfs-gphoto2 gvfs-mtp gvfs-smb gvfs-nfs networkmanager network-manager-applet gedit gnome-system-monitor gnome-calculator xfce4-terminal && systemctl disable dhcpcd.service && systemctl enable NetworkManager.service ;;
