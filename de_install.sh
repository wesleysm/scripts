...
5) pacman -Sy plasma-desktop kde-l10n-pt_br breeze-gtk kde-gtk-config plasma-pa dolphin kdenetwork-filesharing systemd-kcm konsole plasma-nm ark kate kcalc plasma-workspace-wallpapers user-manager sddm-kcm ;;
6) exit ;;
